...
import jsbeautifier
import traceback
from PDFUtils import clearScreen, countArrayElements, countNonPrintableChars, escapeRegExpString, getBytesFromFile, hexToString, vtcheck
from PDFCrypto import xor
from JSAnalysis import analyseJS, isJavascript, unescape
from PDFCore import (MAL_ALL, MAL_BAD_HEAD, MAL_EOBJ, MAL_ESTREAM, MAL_HEAD,
